...
{{#rustdoc_include ../../../wtx-examples/examples/web-socket-client.rs}}
```
...
```rust,edition2024,no_run
{{#rustdoc_include ../../../wtx-examples/examples/web-socket-client-concurrent.rs}}
```
...
```rust,edition2024,no_run
{{#rustdoc_include ../../../wtx-examples/examples/web-socket-server.rs}}
```
