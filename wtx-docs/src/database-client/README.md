...
{{#rustdoc_include ../../../wtx-examples/examples/database-client-postgres.rs}}
```
...
```rust,edition2024,no_run
{{#rustdoc_include ../../../wtx-examples/examples/database-client-postgres-batch.rs}}
```
...
```rust,edition2024,no_run
{{#rustdoc_include ../../../wtx-examples/examples/database-client-tests.rs}}
```
