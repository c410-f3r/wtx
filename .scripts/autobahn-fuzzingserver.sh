...
cargo build --bin autobahn-client --features flate2,optimization,parking_lot,tokio,web-socket-handshake --profile bench
...
sleep 5
cargo run --bin autobahn-client --features flate2,optimization,parking_lot,tokio,web-socket-handshake --profile bench
