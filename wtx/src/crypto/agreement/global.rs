...
type P256Ty = cfg_select! {
  feature = "crypto-ring" => crate::crypto::EcdhP256Ring,
...
#[derive(Debug)]
pub struct EcdhP256Global(P256Ty);

impl Agreement for EcdhP256Global {
...
/// A structure that delegates execution to the selected crypto backend.
#[derive(Debug)]
pub struct EcdhP384Global(P384Ty);

impl Agreement for EcdhP384Global {
