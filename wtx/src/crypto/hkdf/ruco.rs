use crate::crypto::{CryptoError, Hkdf, HkdfSha256Ruco, HkdfSha384Ruco};
use crypto_common::{KeyInit as _, Output};
use hmac::{Mac, SimpleHmac};

impl Hkdf for HkdfSha256Ruco {
