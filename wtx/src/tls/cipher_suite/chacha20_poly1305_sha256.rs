...
impl CipherSuite for Chacha20Poly1305Sha256<crate::tls::AwsLc> {
  ...
  type Aead = crate::tls::cipher_suite::Chacha20Poly1305AwsLc;
  type Hash = crate::tls::cipher_suite::Sha256AwsLc;
}

#[cfg(feature = "ring")]
impl CipherSuite for Chacha20Poly1305Sha256<crate::tls::Ring> {
  const TY: CipherSuiteTy = CipherSuiteTy::Aes256GcmSha384;

  type Aead = crate::tls::cipher_suite::Chacha20Poly1305Ring;
