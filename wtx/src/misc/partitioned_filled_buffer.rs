use crate::misc::{suffix_writer::SuffixWriterFbvm, FilledBuffer, Lease, LeaseMut, SuffixWriter};
use core::ops::Range;
...
impl PartitionedFilledBuffer {
  ...
  #[inline]
  pub(crate) fn suffix_writer(&mut self) -> SuffixWriterFbvm<'_> {
    SuffixWriter::new(self._following_end_idx(), self._buffer._vector_mut())
  }
