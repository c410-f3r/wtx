...
#[cfg(feature = "borsh")]
mod borsh {
  use crate::de::{DecError, format::Borsh, protocol::VerbatimDecoder};
  use borsh::{BorshDeserialize, BorshSerialize};

  _impl_dec! {
    VerbatimDecoder<(D): BorshDeserialize>,
    Borsh,
    |_aux, dw| {
  ...
  _impl_enc! {
    VerbatimDecoder<D: BorshSerialize>,
    Borsh,
    |this, _aux, ew| {
...
mod quick_protobuf {
  use crate::de::{DecError, format::QuickProtobuf, protocol::VerbatimDecoder};
