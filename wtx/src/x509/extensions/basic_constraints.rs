use crate::{
  asn1::{
    Asn1DecodeWrapperAux, Asn1EncodeWrapperAux, BOOLEAN_TAG, Boolean, INTEGER_TAG, Len, Opt,
...
impl<'de> Decode<'de, GenericCodec<Asn1DecodeWrapperAux, ()>> for BasicConstraints {
  #[inline]
...
impl Encode<GenericCodec<(), Asn1EncodeWrapperAux>> for BasicConstraints {
  #[inline]
