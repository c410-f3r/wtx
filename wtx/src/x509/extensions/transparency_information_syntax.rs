...
pub struct TransparencyInformationSyntax<B>(
  /// See [`Octetstring`].
  pub Octetstring<B>,
);

impl<'de, B> Decode<'de, GenericCodec<Asn1DecodeWrapperAux, ()>>
  for TransparencyInformationSyntax<B>
where
...
impl<B> Encode<GenericCodec<(), Asn1EncodeWrapperAux>> for TransparencyInformationSyntax<B>
where
  B: Lease<[u8]>,
{
  #[inline]
