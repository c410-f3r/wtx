use crate::database::client::mysql::{Mysql, MysqlRecord};
...
impl<'exec, E> crate::database::Records<'exec> for MysqlRecords<'exec, E>
where
  E: From<crate::Error>,
{
  ...
  #[inline]
  fn get(&self, _: usize) -> Option<MysqlRecord<'exec, E>> {
    None
  }
