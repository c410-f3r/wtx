...
use crate::database::{
  executor::Executor,
  sm::{DbMigration, MigrationGroup, UserMigration},
...
#[inline]
pub(crate) async fn _migrations_by_mg_version_query<E>(
  buffer_cmd: &mut String,
  executor: &mut E,
  mg_version: i32,
...
where
  E: Executor,
  DbMigration: for<'rec> FromRecord<crate::Error, <E::Database as Database>::Record<'rec>>,
{
  buffer_cmd.write_fmt(format_args!(
    "SELECT \
