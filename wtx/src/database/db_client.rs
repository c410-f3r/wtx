...
pub trait DbClient {
  ...
  /// Execute - None
  ///
  /// A version of [`DbClient::execute_many`] where no records are expected.
  #[inline]
  fn execute_none(
    &mut self,
    cmd: &str,
  ...
  /// Execute - Optional
  ///
  /// A version of [`DbClient::execute_many`] where at most one record is expected.
  #[inline]
  fn execute_optional(
    &mut self,
    cmd: &str,
  ...
  /// Execute - Single
  ///
  /// A version of [`DbClient::execute_many`] where a single record is expected.
  #[inline]
  fn execute_single(
    &mut self,
    cmd: &str,
  ...
  ///
  /// A version of [`DbClient::execute_stmt_many`] where returned values are ignored.This
  /// is the most performant variation.
  #[inline]
  ...
  ///
  /// A version of [`DbClient::execute_stmt_many`] where at most one record is expected.
  #[inline]
  ...
  ///
  /// A version of [`DbClient::execute_stmt_many`] where a single record is expected.
  #[inline]
