use crate::rng::{xor_numbers, xor_u8, xor_u8_16, xor_u8_4, xor_u8_8, Rng};
use core::{
...
impl Rng for StdRngSync {
  #[inline]
  fn u8(&mut self) -> u8 {
    crate::rng::u8(self.modify())
  }

  #[inline]
  fn u8_4(&mut self) -> [u8; 4] {
    crate::rng::u8_4(self.modify())
  }

  #[inline]
  fn u8_8(&mut self) -> [u8; 8] {
    crate::rng::u8_8(self.modify())
  }

  #[inline]
  fn u8_16(&mut self) -> [u8; 16] {
    crate::rng::u8_16(self.modify(), self.modify())
  }
}
